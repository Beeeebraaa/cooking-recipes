...
export const Pancakes: FC<RoutableProps> = () => {
  ...
  return (
    <div class="container">
      ...
      <div class="d-flex flex-column gap-2 mt-5 mb-2">
        <video class="w-100 h-100 max-width-300 max-height-300 object-fit-cover rounded-3" src="./recipes-images/pancakes/4.mp4" muted autoplay loop></video>
      ...
      <div class="d-flex flex-column gap-2 mt-5 mb-2">
        <video class="w-100 h-100 max-width-300 max-height-500 object-fit-cover rounded-3" src="./recipes-images/pancakes/5.mp4" muted autoplay loop></video>
        <p class="bg-warning bg-opacity-75">Выкладываем ложку полученной массы на скороводку.</p>
      </div>

      <div class="d-flex flex-column gap-2 mt-5 mb-2">
        <video class="w-100 h-100 max-width-300 max-height-500 object-fit-cover rounded-3" src="./recipes-images/pancakes/6.mp4" muted autoplay loop></video>
